...
function dropBox() {
  ...
  if (thisBox.data("test")) {
    thisBox.css({
      background:
        "url('http://icons.iconarchive.com/icons/hopstarter/halloween-avatars/128/Frankenstein-icon.png')",
      "background-size": "contain",
    });
  } else {
    thisBox.css({
      background:
        "url('http://icons.iconarchive.com/icons/hopstarter/halloween-avatars/128/Scream-icon.png')",
      "background-size": "contain",
    });
  }
